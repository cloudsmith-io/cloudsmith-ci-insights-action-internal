...
class TestPythonLogParsing:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                """,
                ("workspace-name", "repository-name", "python-gitlab", "3.1.1", "python"),
            )
        ],
    )
    ...
    def test_python_multiple_matches_returns_in_order(self):
        ...
        assert parse_logs_for_all_details(log)[0] == ("first", "ns", "firstpkg", "1.0.0", "python")
        assert parse_logs_for_all_details(log) == [
            ("first", "ns", "firstpkg", "1.0.0", "python"),
            ("second", "ns", "secondpkg", "2.0.0", "python"),
        ]
    ...
    def test_python_multiple_matches_with_duplicates(self):
        ...
        assert parse_logs_for_all_details(log) == [
            ("acme", "tools", "dupkg", "1.2.3", "python"),
            ("acme", "tools", "other", "2.0.0", "python"),
        ]
    ...
    def test_python_parse_logs_for_all_details_complex_name_and_version(self):
        ...
        assert parse_logs_for_all_details(log)[0] == ("acme", "tools", "my.pkg-name", "12.0.0.post1", "python")
    ...
    def test_python_parse_logs_for_all_details_no_version_in_error_line_but_artifact_present(self):
        ...
        assert parse_logs_for_all_details(log)[0] == ("ws", "repo", "python-gitlab", "6.3.0", "python")
    ...
    def test_python_no_version_fallback_looks_elsewhere_for_artifact(self):
        ...
        assert parse_logs_for_all_details(log)[0] == ("ws2", "repo2", "fallbackpkg", "2.4.0", "python")
    ...
    def test_python_fallback_tarball_url_only(self):
        ...
        assert parse_logs_for_all_details(log)[0] == ("acme", "observability", "agentlib", "1.9.0", "python")
